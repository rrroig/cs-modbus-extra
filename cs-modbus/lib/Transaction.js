...
Transaction.fromOptions = function(options)
{
  ...
  {
    transaction.setenableEcho(options.enableEcho);
  }
  */
...
/* moved to transport options rtu
 * 
Transaction.prototype.setenableEcho = function(enableEcho)
{
  if (typeof enableEcho !== 'boolean')
  {
    throw new Error(util.format(
      "Invalid enable echo value "
